...
import SendVerificationCode from "./SendVerificationCodeForm";
...
function ConfirmButton() {
    ...
    return (
        <button
            className={`mt-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded ${pending ? 'opacity-50 cursor-not-allowed' : ''}`}
            disabled={pending}
        >
